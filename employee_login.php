...
<html>
	<head>
		...
		<title>Govt Polytechic Jaunpur/Employee Login</title>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item dropdown active" style="font-size:20px;">
				...
				<div class="dropdown-menu bg-dark active" style="font-size:20px;">
					...
					<a class="dropdown-item text-warning" href="./employee_login.php"> Employee Login </a>
	...
	<div class="row bg-dark" style="min-height:500px;" id="font_family">	
		<div class="col-sm-5 bg-dark" style="margin:0px auto;min-height:550px;">
			<br/>
			<?php
			if(isset($_GET['msg']))
			{
				...
				{
					echo "
					<div class='alert alert-dismissible fade show col-sm-12 mx-auto' role='alert' style='background:#fff;color:green;border:2px solid green;'>
				...
				{
					echo "
					<div class='alert alert-dismissible fade show col-sm-12 mx-auto' role='alert' style='background:#fff;color:red;border:2px solid red;'>
						<strong class='h5'>Congratulation!</strong> ".$msg.".
						<button type='button' class='close' data-dismiss='alert' aria-label='Close'>
						<span aria-hidden='true'>&times;</span>
						</button>
  ...
  <path fill-rule="evenodd" d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
						...
						<u><b>Employee Login</b></u></p>
			<br/>
			<form action="employee_login_code.php" method="post">
					<div class="form-row text-white">
					<div class="form-group col-sm-10 h4">
						<label for="inputName4">Email Address</label>
						<br/>
						<br/>
						<input type="text" class="form-control" name="email" id="inputName4" placeholder="Employee Id" required autofocus>
					<br/>
						<label for="inputDate4">Password</label>
						<br/>
						<br/>
						<input type="password" class="form-control" name="password" id="tb" placeholder="Password" required onkeyup="valid()">
						<input type="checkbox" onclick="myFunction()"><span class="h6"> Show Password</span>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<span class="h6" id="sp"></span>
					</div>
					</div>
					<br/>
					<button type="submit" class="btn btn-warning"><span class="fa fa-sign-in"> <b id="font_family">Login</span></b></button>
					<span><a href="emp_forget.php" class="text-warning h5"> Forget Password <i class="fa fa-refresh"></i> </a></span>
				</form>
		</div>
	</div>
