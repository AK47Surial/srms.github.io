...
<html>
	...
	<nav class="navbar navbar-expand-sm sticky-top" style="background:#07ad39">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item active" style="font-size:20px;">
				<a class="nav-link hvr-wobble-vertical fa fa-download text-warning" href="./show_result.php"><span id="font_family"> Results </span></a>
			</li>
	...
	<div class="row bg-dark" style="min-height:400px;" id="font_family">	
		<div class="col-sm-5 bg-dark" style="margin:0px auto;min-height:400px;">
			<br/>
			<br/>
			<br/>
			<p class="h1 text-warning">Show Examination Result</p>
			<br/>
			<form action="show_result_code.php" method="post">
					<div class="form-row text-white">
					<div class="form-group col-sm-10 h4">
						<label for="inputName4">Roll Number</label>
						<br/>
						<br/>
						<input type="text" class="form-control" name="roll_no" id="inputName4" placeholder="Roll Number" required>
					</div>
					</div>
					<br/>
					<button type="submit" class="btn btn-warning"><span class="fa fa-download"> <b id="font_family">Show Result</span></b></button>
				</form>
		</div>
	</div>
