...
<html>
	...
	<div class="row">
	<div class="w-100">
	<nav class="navbar navbar-expand-sm sticky-to" style="background:#07ad39;">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item active" style="font-size:20px;">
				<a class="nav-link hvr-wobble-vertical fa fa-phone text-warning" href="./contact_us.php"><span id="font_family"> Contact Us </span></a>
			</li>
			<li class="nav-item" style="font-size:20px;">
	...
	<div class="row bg-dark" style="min-height:600px;" id="font_family">
		<div class="col-sm-6">  
			<div class="col-sm-9" style="margin : 0px auto;">	
				</br>
				<p class="h1 text-warning">Contact Us</p>
				<p class="text-warning">You can send your message by given below form...</p>
				<!-- form started here..-->
				...
				<form action="massage.php" method="post">
					...
					<div class="form-group col-md-12">
						...
						<input type="text" class="form-control" name="name" id="inputName4" placeholder="Full Name " required>
					</div>
					<div class="form-group col-md-12">
					...
					<div class="form-group text-white">
						...
						<input type="number" class="form-control" name="mobile" id="inputMobile" placeholder="Mobile No.">
					</div>
					<div class="form-group text-white">
					...
					<div class="form-group">
						...
						<button type="submit" class="btn btn-warning"><span class="fa fa-send"> <b id="font_family">Send Message</span></b></button>
				</form>
		...
		<div class="col-sm-6">  
			...
			<div class="col-sm-9" style="margin:0px auto;">
				...
				<p class="h1 text-warning">About College</p>
				<br/>
				<br/>
				<p class="h4 text-warning">Address : </p>
				<p class="h5 text-justify text-white">Government Polytechnic (Behind Singh Cold Storage), Jaunpur, Varanasi Highway Jagdishpur, Jaunpur 222002</p>
				<p class="h4 text-warning">Phone : </p>	
				<p class="h5 text-white">05452- 261644/45 </p>
				<p class="h4 text-warning">Email Address :</p>
				<p class="h5"><a href="govtpolyjnp@yahoo.co.in" class="text-white">govtpolyjnp@yahoo.co.in</a></p>
				<p class="h4 text-warning">Fax : </p>
				<p class="h5 text-white">05452-261645</p>
				<br/>
				<br/>
			</div>
	...
	<div class="row" style="min-height:500px;">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3594.700568269706!2d82.7003986754683!3d25.71433625245126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39903bb8f327527b%3A0x3a2853d99a687975!2sGovernment%20Polytechnic!5e0!3m2!1sen!2sin!4v1594454464115!5m2!1sen!2sin" width="100%" height="500" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>	</div>
