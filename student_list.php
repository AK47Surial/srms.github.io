...
<html>
	...
	<body>
		...
		<div id="main" style="background:#88ff00;">
			<span style="font-size:30px;cursor:pointer;color:green;text-shadow:5px 5px 10px;" onclick="openNav()" class="hvr-float" ><span style="color:#ffc107;">&#9776;</span> This is Student List of Institute <a href="employee_dashboard.php">....</a></span></span>
		</div>
		<!-- Side Nav Slide Code -->
		
		<!-- Student List Codes Here.......  -->
		
		<div class="container-fluid" style="background:#d1e0e0;">
			<div class="row" style="min-height:150px;">
				<div class="col-sm-6 mx-auto">
					<p></p>
					<p class="h1 text-center text-dark" style="font-family:sans-serif;"><b> Student List </b></p>
					
					<form class="form-inline mx-auto" action="student_list.php" method="post">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<div class="form-group text-white col-sm-3">
