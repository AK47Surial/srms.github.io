	...
	<body>
		<div class="container-fluid" style="background:#88ff00;">
			<div id="mySidenav" class="sidenav">
				...
				<a href="./emp_cpw.php" class="text-white"><i class="fa fa-lock"></i> Change Password</a>
				<a href="./employee_logout.php"><i class="fa fa-sign-out"></i> Logout</a>
			</div>
		</div>	
		
		<div id="main" style="background-color:#88ff00;">
			<span style="font-size:30px;cursor:pointer;color:green;text-shadow:5px 5px 10px;" onclick="openNav()" class="hvr-float" ><span style="color:#ffc107;">&#9776;</span> Employee Can Change Password Here...</span>
		</div>
		<!-- Side Nav Slide Code -->
		...
		<?php
			...
			<div class="col-sm-4 mx-auto" style="min-height:550px;border:1px solid #2db300;border-radius:10px;box-shadow:1px 1px 10px 0px #88ff00;background:rgba(0,0,0,0.6);">
				...
				<br/>
				<form action="emp_cpw_code.php" method="post" class="text-white">
					...
					<button type="submit" class="btn text-white border btn-sm" style="background:green;"> <i class="fa fa-send"></i> Change</button>
				</form>
			</div>
